...
var runTrack_1 = __importDefault(require("./runTrack"));
        ...
        whenTimeoutError: function (_ms) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, runTrack_1.default)(res, mapper_http_erros_1.default.TIMEOUT)];
        ...
        whenInternalServerError: function (_ms) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, runTrack_1.default)(res, mapper_http_erros_1.default.INTERNAL_SERVER_ERROR)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        }); },
        whenServiceUnavailableError: function (_ms) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, runTrack_1.default)(res, mapper_http_erros_1.default.SERVICE_UNAVAILABLE)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        }); },
